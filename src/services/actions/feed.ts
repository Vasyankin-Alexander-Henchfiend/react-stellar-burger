...
export const FEED_WS_GET_DATA: "FEED_WS_GET_DATA" = "FEED_WS_GET_DATA";
export const FEED_WS_CONNECTION_FINISHED: 'FEED_WS_CONNECTION_FINISHED' = 'FEED_WS_CONNECTION_FINISHED'
...
export const wsFeedGetData = (message: TOrdersData) => {
  return {
